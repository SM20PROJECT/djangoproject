...
class MongoClient(common.BaseObject):
    ...
    """
    HOST = "mongodb+srv://admin:e1P21ldaq3dfcTEf@sm-ydt12.mongodb.net/smp_db"#localhost yerine 'mongodb+srv://<user>:<password>@sm-ydt12.mongodb.net' şeklindeki linki yapıştır
    PORT = 27017
